...
DELIMITER ;;
CREATE DEFINER=`gbb_wayfinder`@`%` PROCEDURE `sp_insert_location`(
	IN vid INT,     
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`gbb_wayfinder`@`%` PROCEDURE `sp_trunc_locations`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`gbb_wayfinder`@`%` PROCEDURE `sp_trunc_location_categories`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_update_advisory` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`gbb_wayfinder`@`%` PROCEDURE `sp_update_advisory`(
	IN vid INT,     
    IN vname VARCHAR(255),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`gbb_wayfinder`@`%` PROCEDURE `sp_update_events`(
	IN vid INT,     
    IN vname VARCHAR(255),
    IN vlocationid INT,
    IN vfeaturedimage VARCHAR(2048),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`gbb_wayfinder`@`%` PROCEDURE `sp_update_features`(
	IN vid INT,     
    IN vname VARCHAR(255),
    IN vlocationtype VARCHAR(255),
    IN viconpath VARCHAR(2048),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`gbb_wayfinder`@`%` PROCEDURE `sp_update_itineraries`(
	IN vid INT,     
    IN vname VARCHAR(255),
...
/*!50013 DEFINER=`gbb_wayfinder`@`%` SQL SECURITY DEFINER */
...
-- Dump completed on 2022-08-01 15:16:41
